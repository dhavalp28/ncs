                        ...
                        <div class="footer__widget-6 mb-50 footer-col-6-1">
                           <div class="footer__logo">
                              <a href="home-main.html">
                                 <img src="assets/img/logo/logo.svg" alt="NCS Logo" style="width:100%">
                              </a>
                           </div>

                           <div class="footer__widget-content">
                              <div class="footer__info">
                                 <p>Novusha Consulting Services India LLP, an esteemed part of the Suraj Group of Companies and an Authorised Odoo Reseller, specialises in bespoke Odoo solutions that significantly enhance operational efficiency in the manufacturing sector.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                              ...
                              <div class="footer__info">
                                 <div class="footer__info-item-6 d-flex align-items-start">
                                    ...
                                    <div class="footer__info-text-6">
                                       <a target="_blank" href="https://maps.app.goo.gl/xgdg5MeVfFfZ6Ufh9">A-306 Wall Street II, Opp. Orient Club, near Gujarat College, Ahmedabad, Gujarat 380006 | India</a>
                                    </div>
                                 </div>
                                 <div class="footer__info-item-6 d-flex align-items-start">
                                    <div class="footer__info-icon-6 mr-20">
                                    ...
                                    <div class="footer__info-text-6">
                                       <a href="mailto:hi@novusha.com">hi@novusha.com</a>
                                    </div>
                                 </div>
                                 <div class="footer__info-item-6 d-flex align-items-start">
                                    <div class="footer__info-icon-6 mr-20">
                                    ...
                                    <div class="footer__info-text-6">
                                       <a href="tel:919662370774">+91 96623 70774</a>
                                    </div>
                                 </div>
                              </div>
            ...
            <div class="footer__bottom">
               <div class="container">
                  <div class="footer__bottom-inner-6">
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="footer__copyright-6" style="text-align:right">
                              <p>© 2024 NCS - Novusha Consulting Services LLP All Rights Reserved.</p>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <a href="https://wa.me/919662370774" class="whatsapp-icon" target="_blank">
         <img src="assets/img/sm/wp.png" alt="WhatsApp">
      </a>
