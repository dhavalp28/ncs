		...
		<div class="tp-theme-wrapper">
		   ...
		   <div class="tp-theme-settings">
				 ...
				 <div class="row row-cols-4 gy-2 gx-2">
					<div class="col">
					   <div class="tp-theme-color-item tp-color-active">
						  <button class="tp-theme-color-btn tp-color-settings-btn d-none" data-color-default="#FAB825" type="button" data-color="#FAB825"></button>
						  <button class="tp-theme-color-btn tp-color-settings-btn" type="button" data-color="#FAB825"></button>
					   </div>
					</div>
					<div class="col">
					   <div class="tp-theme-color-item tp-color-active">
			  ...
			  <div class="tp-theme-color-input">
				 ...
				 <input type="color" id="tp-color-setings-input" value="#FAB825">
